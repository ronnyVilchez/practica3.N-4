    ...
    return (
        <section className='flex flex-row relative gap-8 w-full h-full mt-[6rem] px-[4rem]'>
            <div className='flex flex-col  w-[50%] gap-4 my-auto pl-[5rem] pr-[2rem]'>
                ...
                <h1 className='text-[48px] font-bellefair'>ANOUSHEH ANSARI</h1>
                <p className='text-[18px] text-[#D0D6F9] pb-8 '>Anousheh Ansari is an Iranian American engineer and co-founder of Prodea Systems. Ansari was the fourth self-funded space tourist, the first self-funded woman to fly to the ISS, and the first Iranian in space. </p>
